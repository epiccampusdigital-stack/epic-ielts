...
const fixes = [
  ...
  { ids: [6, 433], options: [
    'A. The desire to return to traditional farming methods',
    'B. The need to produce food closer to where people live',
    'C. Government subsidies for agricultural businesses',
    'D. A decline in rural farming productivity'
  ]},
  { ids: [7, 434], options: [
    'A. It increases the use of chemical pesticides',
    'B. It reduces the need for transportation of goods',
    'C. It reduces carbon emissions from food transportation',
    'D. It replaces all traditional agricultural land'
  ]},
  { ids: [8, 435], options: [
    'A. Digging underground farms beneath city streets',
    'B. Using vertical growing systems and rooftop gardens',
  ...
  { ids: [9, 436], options: [
    ...
    'C. The initial cost of setting up urban farms is high',
  ...
  { ids: [10, 437], options: [
    ...
    'C. Urban farming can be expensive to establish and maintain',
  ...
  { ids: [16, 443], options: [
    ...
    'C. The tendency to favour information that supports existing beliefs',
  ...
  { ids: [17, 444], options: [
    ...
    'C. Because of social pressure and the desire to conform',
  ...
  { ids: [18, 445], options: [
    ...
    'C. It can lead to impulsive or overly risky choices',
  ...
  { ids: [20, 447], options: [
    ...
    'C. People can make more rational and informed choices',
  ...
  // ── PAPER 002 – Memory & Brain (Q16–20) ────────────────────────────
  { ids: [56], options: [
    'A. The brain\'s ability to generate new neurons throughout adulthood',
  ...
  { ids: [88], options: [
    ...
    'B. That formalising it could distract from reducing emissions now',
  ...
  { ids: [89], options: [
    ...
    'B. They may trigger irreversible changes in the Earth system',
  ...
  { ids: [90], options: [
    ...
    'B. To shift attention toward the social and economic causes of change',
  ...
  { ids: [100], options: [
    ...
    'B. The tendency to feel losses more strongly than equivalent gains',
  ...
  { ids: [101], options: [
    ...
    'C. It preserves freedom of choice while guiding better decisions',
  ...
  { ids: [103], options: [
    ...
    'B. That some findings in behavioural economics may not be reliable',
  ...
  // ── PAPER 003 – AI & Inequality (Q36–38) ───────────────────────────
  { ids: [116], options: [
    'A. AI systems are deliberately programmed to disadvantage minorities',
    'B. AI systems trained on biased data replicate existing inequalities',
  ...
  { ids: [117], options: [
    'A. Existing frameworks assign clear liability to AI manufacturers',
    ...
    'D. Current legal systems struggle to assign responsibility for AI harm'
  ]},
  { ids: [118], options: [
    ...
    'C. It reflects the interests of powerful nations rather than all countries',
  ...
  { ids: [166], options: [
    ...
    'B. Employers could reduce spending on office space and facilities',
  ...
  { ids: [167], options: [
    ...
    'C. Employees may find it difficult to switch off from work',
  ...
  { ids: [168], options: [
    ...
    'C. Junior employees miss out on informal learning and mentorship',
  ...
  { ids: [169], options: [
    ...
    'C. Hybrid models attempt to balance the benefits of both arrangements',
  ...
  { ids: [170], options: [
    ...
    'B. The five-day office week is unlikely to return for most workers',
  ...
  { ids: [176], options: [
    ...
    'B. Technological improvements and economies of scale in manufacturing',
  ...
  { ids: [177], options: [
    ...
    'C. The intermittent nature of wind and solar power generation',
  ...
  { ids: [178], options: [
    ...
    'B. Because of job losses in traditional fossil fuel industries',
  ...
  { ids: [179], options: [
    ...
    'C. Both sectors face unique challenges in switching to renewable power',
  ...
  { ids: [196], options: [
    ...
    'B. It impairs the prefrontal cortex and reduces emotional regulation',
    'C. It increases activity in the amygdala beyond normal levels',
  ...
  { ids: [197], options: [
    ...
    'B. It suppresses melatonin production delaying the onset of sleep',
  ...
  // ── PAPER 005 – Antibiotics & AMR (Q6–10) ──────────────────────────
  { ids: [353], options: [
    'A. It was the first medicine ever to be produced in a laboratory',
    'B. It could be produced cheaply enough to treat large populations',
    'C. It was effective against a wider range of bacteria than expected',
    'D. It was discovered accidentally making it particularly celebrated'
  ]},
  { ids: [354], options: [
    ...
    'C. The overuse and misuse of antibiotics accelerates resistance development',
  ...
  { ids: [355], options: [
    ...
    'D. Limited financial return makes antibiotic development unattractive'
  ]},
  { ids: [356], options: [
    'A. They have already eliminated the overuse of antibiotics in hospitals',
    'B. They could help reduce unnecessary antibiotic prescriptions',
    'C. They are too expensive to be used in low-income countries',
    'D. They have replaced the need for new antibiotic development'
  ]},
  { ids: [357], options: [
    'A. Resistant bacteria can spread rapidly across international borders',
  ...
  { ids: [367], options: [
    ...
    'B. The phenomenon where urban areas are significantly warmer than surrounding rural areas',
  ...
  { ids: [368], options: [
    ...
    'C. Trees provide shade that reduces the energy needed for cooling buildings',
    'D. Trees absorb noise pollution improving the working environment inside'
  ]},
  { ids: [369], options: [
    'A. More frequent droughts and extreme heat events threaten tree survival',
  ...
  { ids: [370], options: [
    ...
    'D. They aim to ensure all communities benefit equally from urban greenery'
  ]},

  // ── PAPER 005 – Emotional Intelligence (Q33–36) ────────────────────
  { ids: [380], options: [
    'A. It was immediately rejected by the academic psychology community',
    'B. It brought the concept of emotional intelligence to a wide audience',
  ...
  { ids: [381], options: [
    ...
    'C. Different EI tests often measure different constructs inconsistently',
    'D. EI measurement relies too heavily on self-reported data from managers'
  ]},
  { ids: [382], options: [
    'A. EI training reliably improves both wellbeing and work performance',
    'B. EI training has no measurable effect on employee productivity',
  ...
  { ids: [383], options: [
    ...
    'D. It highlights the role of emotion in cognition and social interaction'
  ]},

  // ── PAPER 006 – Coffee History (Q7–10) ─────────────────────────────
  { ids: [653], options: [
    'A. Ethiopian monks who used it to stay awake during prayers',
    'B. Arab traders and scholars who began brewing and drinking it',
    'C. European merchants who imported beans from East Africa',
    'D. Ottoman soldiers who carried roasted beans on military campaigns'
  ]},
  { ids: [654], options: [
    ...
    'C. They became centres for intellectual debate and social exchange',
  ...
  { ids: [655], options: [
    ...
    'B. It comes from the Indonesian island that supplied much early coffee',
  ...
  { ids: [656], options: [
    ...
    'B. Coffee has become deeply embedded in cultures around the world',
  ...
  { ids: [680], options: [
    ...
    'B. They miss informal mentoring and networking opportunities in the office',
  ...
  { ids: [682], options: [
    ...
    'C. The future workplace will require a renegotiation of old working norms',
...
async function main() {
  console.log(`Starting MCQ options fix for ${fixes.length} question groups...`);
  let updated = 0;

  for (const fix of fixes) {
    const optionsJson = JSON.stringify(fix.options);
    await prisma.question.updateMany({
      where: { id: { in: fix.ids } },
      data: { options: optionsJson }
    });
    updated += fix.ids.length;
    console.log(`✅ Updated question ids: ${fix.ids.join(', ')}`);
  }

  console.log(`\n✅ Done. Updated ${updated} question rows.`);
